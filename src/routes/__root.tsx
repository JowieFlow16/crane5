    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-subtle px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full bg-gradient-primary px-5 py-2.5 text-sm font-medium text-primary-foreground transition-opacity hover:opacity-90"
          >
            Go home
          </Link>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Omicron AI — AI Tutor for Ugandan Students" },
      {
        ...
        content:
          "Learn smarter with an AI tutor built for the Ugandan NCDC curriculum — chat, quizzes, and revision.",
      },
...
const themeInitScript = `(function(){try{var t=localStorage.getItem('omicron-theme');if(t==='dark'){document.documentElement.classList.add('dark');}}catch(e){}})();`;
